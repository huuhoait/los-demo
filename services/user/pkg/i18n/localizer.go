...
func NewLocalizer(cfg *Config) (*Localizer, error) {
	...
	// TODO: Load locale files when embed issue is resolved
...
// GetErrorMessage is an alias for LocalizeError for backward compatibility
func (l *Localizer) GetErrorMessage(lang, errorCode string, templateData map[string]interface{}) string {
	return l.LocalizeError(lang, errorCode, templateData)
}
